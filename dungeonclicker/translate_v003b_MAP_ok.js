...
translation_table.set("purchase!",		"Αγόρασε");
translation_table.set("Purchased",		"Αγοράστηκε");
translation_table.set("purchase!",		"Αγοράστηκε!");
//building names
...
translation_table.set("λυκάνθρωπος","");
...
translation_table.set("dark elves","σκοτεινά ξωτικά");
...
translation_table.set("You <span class='heroic'>open the Gate of Hope</span>! You earn <span class='coin'>#coin#</span>.","You <span class='heroic'>open the Gate of Hope</span>! You earn <span class='coin'>#coin#</span>.");
translation_table.set("You <span class='heroic'>defeat the Krakhon army</span>! You earn <span class='coin'>#coin#</span>.","You <span class='heroic'>defeat the Krakhon army</span>! You earn <span class='coin'>#coin#</span>.");
translation_table.set("You <span class='heroic'>destroy the Chalice of Agony</span>! You earn <span class='coin'>#coin#</span>.");
translation_table.set("You <span class='heroic'>discover the Elvenpath</span>! You find <span class='coin'>#coin#</span>.");
translation_table.set("You <span class='heroic'>unchain Arwald's soul</span>! You earn <span class='coin'>#coin#</span>.");
translation_table.set("You <span class='heroic'>protect Village Lanterne</span>! You earn <span class='coin'>#coin#</span>.");
translation_table.set("You <span class='heroic'>vanquish the Blackbird Nation</span>! You earn <span class='coin'>#coin#</span>.");
translation_table.set("You <span class='heroic'>face the Thing that Should Not Be</span>! You earn <span class='coin'>#coin#</span>.");

//	if (hasBuff("Book of Antonidas")) {
translation_table.set("You <span class='heroic'>cleanse the world of the Corruption</span>! You earn <span class='coin'>#coin#</span>.");
translation_table.set("You <span class='heroic'>slay the Ender Dragon</span>! You earn <span class='coin'>#coin#</span>.");
translation_table.set("You <span class='heroic'>slay the Czar Dragon</span>! You earn <span class='coin'>#coin#</span>.");
translation_table.set("You <span class='heroic'>close the Dark Portal</span>! You earn <span class='coin'>#coin#</span>.");
translation_table.set("You <span class='heroic'>explore Turtle Rock</span>! You find <span class='coin'>#coin#</span>.");
translation_table.set("You <span class='heroic'>climb the Endless Tower</span>! You earn <span class='coin'>#coin#</span>.");
translation_table.set("You <span class='heroic'>raid the Veriil dungeon</span>! You earn <span class='coin'>#coin#</span>.");
translation_table.set("You <span class='heroic'>mend the leg of a black mare</span>! You earn <span class='coin'>#coin#</span>.");

//Adventure
translation_table.set("You earn <span class='coin'>#coin#</span>.","Κέρδισες <span class='coin'>#coin#</span>.");
